...
export const books: Book[] = [
  ...
  { title: "The Regulators",        year: 1996, category: "novel",      pseudonym: "Richard Bachman", blurb: "Same characters as Desperation, alternate reality. Bachman-credited; released the same day as Desperation.", olid: "OL24228762M" },
  ...
  { title: "The Journals of Eleanor Druse", year: 2004, category: "novel", pseudonym: "Eleanor Druse", blurb: "Kingdom Hospital tie-in. King published it as his in-universe character Dr. Eleanor Druse.", olid: "OL3702014M" },
  { title: "Blaze",                 year: 2007, category: "novel",      pseudonym: "Richard Bachman", blurb: "A 1973 trunk novel dusted off and published under Bachman three decades later. Of Mice and Men with a kidnapping.", olid: "OL26411976M" },
  { title: "Charlie the Choo-Choo", year: 2016, category: "children",   pseudonym: "Beryl Evans", blurb: "The in-universe Dark Tower picture book, published in real life under the pseudonymous author from Wolves of the Calla.", olid: "OL26412054M" },
